...
/**
 * Path-style deep links such as /worship silently rendered Home under
 ...
 * known path-style routes are rewritten to their hash equivalents before React
 * mounts. Unknown paths keep the existing behavior.
 */
